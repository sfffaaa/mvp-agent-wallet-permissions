...
// Anvil default dev keys — never use in production
...
async function main() {
  ...
  // AgentExecutor holds ETH in its balance to forward in execute()
  ...
  async function grantAndWait(expirySecs = 3600) {
    const hash = await grantPermission(ownerWallet, pmAddress, agentAccount.address, {
